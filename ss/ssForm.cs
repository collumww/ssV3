...
namespace ss {
	public partial class ssForm : Form {
		...
		public void Delete() {
			...
			if (txt != ed.Log) {
				BeginFormTrans();
				txt.TLog.LogTrans(ssTrans.Type.insert, txt.dot, s);  // you log what the undo will do, not what was just done.
				}
		}
		...
		public void Insert(string s) {
			...
			if (txt != ed.Log) {
				BeginFormTrans();
				txt.TLog.LogTrans(ssTrans.Type.delete, txt.dot, s);  // you log what the undo will do, not what was just done.
				}
		}
